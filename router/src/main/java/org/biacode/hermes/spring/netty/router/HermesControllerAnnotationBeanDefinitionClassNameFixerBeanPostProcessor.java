 ...
 */
@Configuration
public class HermesControllerAnnotationBeanDefinitionClassNameFixerBeanPostProcessor implements BeanPostProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(HermesControllerAnnotationBeanDefinitionClassNameFixerBeanPostProcessor.class);
    ...
    public Object postProcessBeforeInitialization(final Object bean, final String beanName) throws BeansException {
        if (bean.getClass().isAnnotationPresent(HermesController.class)) {
